...
import 'package:testt/Checkout/Add_to_Cart.dart';
import 'package:testt/home/Home.dart';
...
class _DescriptionScreenState extends State<DescriptionScreen> {
  ...
  void productInsert()async{
    ...
    Map<String, dynamic> productDetail = {
      ...
      "Product-Price": widget.price.toDouble(),
                  ...
                  Column(
                    children: [
                      Container(
                        ...
                        child: Text('01: Memory ${widget.memory} \n'
                            '02: Operating System ${widget.operatingSystem} \n'
                            '03: Processor ${widget.processor} \n'
                            '04: Display System ${widget.display} \n'
                            '05: Power Supply: ${widget.power} \n'
                            '06: Battery ${widget.battery} \n'
                            '07: Storage ${widget.storage} ', style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.w700,
                            fontSize: 14
                        ),),
                  ...
                  Column(
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          margin: const EdgeInsets.only(top: 500, left: 70),
                          width: 250,
                          height: 40,
                          decoration: BoxDecoration(
                              color: Colors.white,
