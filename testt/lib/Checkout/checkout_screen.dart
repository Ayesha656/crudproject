...
class CheckOutScreen extends StatefulWidget {
  ...
  var id;
  var name;
  CheckOutScreen({required this.id,required this.name,required this.total,required this.tax,required this.shipping,required this.grandTotal,});
...
get prodId => widget.id;
get prodName => widget.name;

  void checkOut() async{
    String userID = const Uuid().v1();
    Map<String, dynamic>  checkout ={
      "User-ID":userID,
      "Product-ID":prodId.toString(),
      "Product-Name":prodName.toString(),
