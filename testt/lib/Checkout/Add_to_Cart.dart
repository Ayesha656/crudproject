                        ...
                        children: [
                                  ...
                                  Container(
                                    ...
                                    child: GridView.count(
                                      ...
                                      children: List.generate(dataLength, (index) {
                                        ...
                                        String prodId = snapshot.data!.docs[index]['Product-Id'];
                                        ...
                                        num qty = snapshot.data!.docs[index]['Quantity'];

                                        pid=prodId;
                                        pname=name;

                                        double calculateTotal(List<dynamic> products) {
                                          double total = 0.0;

                                          for (var product in products) {
                                            int quantity = product['Quantity'];
                                            double price = double.parse(product['Product-Price'].toString());
                          ...
                          Container(
                            ...
                            child: ElevatedButton(onPressed: (){
                              setState(() {
                                Navigator.push(context, MaterialPageRoute(builder: (context)=> CheckOutScreen(id: pid, name: pname, total: total, tax: tax, shipping: shipping, grandTotal: grandTotal, ),));
